...
\begin{teorema}
{
    Sean $\HH_1$ y $\HH_2$ subespacios vectoriales de $\V$, entonces $\HH_1 \cap \HH_2$ es un subespacio vectorial de $\V$. {\fboxsep=0.2em \fbox{Exte teorema puede estar inluido en el examen}}
